        ...
        <div className="py-10 px-10 md:px-14 flex flex-col justify-center sm:flex-row">
          ...
          >
            ...
            <p className="text-2xl text-white">
              ...
              to you ASAP! {/* <i className="fa-solid fa-arrow-right"></i> */}
            </p>
                    ...
                    <div id="contact-submission" className="flex flex-col mt-5">
                      ...
                      <div className="text-right">
                        <button
                          type="submit"
                          title="Send form"
                          className="cta-btn send-contact-form text-white w-full flex justify-center items-center"
                          disabled={isSubmitting}
                        >
                          Send form <span className={`loader ml-2 ${isSubmitting? 'opacity-100':'!opacity-0'}`}></span>
                        </button>
                      </div>
                    </div>
                  </form>
